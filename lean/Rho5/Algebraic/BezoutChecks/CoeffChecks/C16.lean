/-
D07 — Bézout coefficient identity #16.
...
This is the coefficient of `z^16` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^16` in `A * P + B * P'`. -/
theorem bezoutCoeff16 (g : R) :
    ba6 g * pc10 g + ba7 g * pc9 g + ba8 g * pc8 g + bb7 g * (10 * pc10 g) + bb8 g * (9 * pc9 g) + bb9 g * (8 * pc8 g) = 0 := by

...
-- Frozen V43 case 0 replacement chart, inactive[32] = v1-.
namespace Rho5.LocalAnalysis.V43
noncomputable section
open scoped BigOperators
set_option maxRecDepth 10000

theorem inactive_32 (z : X) (hz : z ∈ cube center radius) :
    (1 / 200 : ℝ) < (inactiveExpr 32).eval z := by
  have he : inactiveExpr 32 = (.add (.const (1 / 1)) (.mul (.const (1 / 1)) (.var 17))) := rfl
  have h := centered_quadratic_lower (726612331 / 500000000)
    ...
    (by intro i; exact Fin.elim0 i)
  have hx : (inactiveExpr 32).eval z = (726612331 / 500000000) + (∑ i, (![(1 / 1)] : Fin 1 → ℝ) i * (![(z 17 - (226612331 / 500000000))] : Fin 1 → ℝ) i) + (∑ i, (![] : Fin 0 → ℝ) i * (![] : Fin 0 → ℝ) i * (![] : Fin 0 → ℝ) i) := by
    rw [he]

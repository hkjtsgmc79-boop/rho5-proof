/-
D07 — Bézout coefficient identity #8.
...
This is the coefficient of `z^8` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^8` in `A * P + B * P'`. -/
theorem bezoutCoeff8 (g : R) :
    ba0 g * pc8 g + ba1 g * pc7 g + ba2 g * pc6 g + ba3 g * pc5 g + ba4 g * pc4 g + ba5 g * pc3 g + ba6 g * pc2 g + ba7 g * pc1 g + ba8 g * pc0 g + bb0 g * (9 * pc9 g) + bb1 g * (8 * pc8 g) + bb2 g * (7 * pc7 g) + bb3 g * (6 * pc6 g) + bb4 g * (5 * pc5 g) + bb5 g * (4 * pc4 g) + bb6 g * (3 * pc3 g) + bb7 g * (2 * pc2 g) + bb8 g * (1 * pc1 g) = 0 := by

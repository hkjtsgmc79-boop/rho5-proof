...
The fixed release \texttt{v1.0.0} provides the certificate downloads,
SHA-256 manifest, file sizes, computing requirements, and recorded
verification scopes:
\url{https://github.com/hkjtsgmc79-boop/rho5-proof/releases/tag/v1.0.0}.
The release does not claim a fresh-machine Lean cold build or a new
end-to-end mathematical replay. Zenodo archival will follow separately.

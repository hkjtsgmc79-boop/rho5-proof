/-
D07 — Bézout coefficient identity #17.
...
This is the coefficient of `z^17` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^17` in `A * P + B * P'`. -/
theorem bezoutCoeff17 (g : R) :
    ba7 g * pc10 g + ba8 g * pc9 g + bb8 g * (10 * pc10 g) + bb9 g * (9 * pc9 g) = 0 := by

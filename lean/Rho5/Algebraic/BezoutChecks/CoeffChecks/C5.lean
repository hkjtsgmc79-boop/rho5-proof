/-
D07 — Bézout coefficient identity #5.
...
This is the coefficient of `z^5` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^5` in `A * P + B * P'`. -/
theorem bezoutCoeff5 (g : R) :
    ba0 g * pc5 g + ba1 g * pc4 g + ba2 g * pc3 g + ba3 g * pc2 g + ba4 g * pc1 g + ba5 g * pc0 g + bb0 g * (6 * pc6 g) + bb1 g * (5 * pc5 g) + bb2 g * (4 * pc4 g) + bb3 g * (3 * pc3 g) + bb4 g * (2 * pc2 g) + bb5 g * (1 * pc1 g) = 0 := by

/-
D07 — Bézout coefficient identity #18.
...
This is the coefficient of `z^18` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^18` in `A * P + B * P'`. -/
theorem bezoutCoeff18 (g : R) :
    ba8 g * pc10 g + bb9 g * (10 * pc10 g) = 0 := by

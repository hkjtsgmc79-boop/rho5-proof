/-
D07 — Bézout coefficient identity #3.
...
This is the coefficient of `z^3` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^3` in `A * P + B * P'`. -/
theorem bezoutCoeff3 (g : R) :
    ba0 g * pc3 g + ba1 g * pc2 g + ba2 g * pc1 g + ba3 g * pc0 g + bb0 g * (4 * pc4 g) + bb1 g * (3 * pc3 g) + bb2 g * (2 * pc2 g) + bb3 g * (1 * pc1 g) = 0 := by

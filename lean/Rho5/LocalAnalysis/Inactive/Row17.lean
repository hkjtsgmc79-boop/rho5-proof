...
-- Frozen V43 case 0 replacement chart, inactive[17] = O00+.
namespace Rho5.LocalAnalysis.V43
noncomputable section
open scoped BigOperators
set_option maxRecDepth 10000

theorem inactive_17 (z : X) (hz : z ∈ cube center radius) :
    (1 / 200 : ℝ) < (inactiveExpr 17).eval z := by
  have he : inactiveExpr 17 = (.add (.add (.add (.const (1 / 1)) (.mul (.const (-1 / 1)) (.var 0))) (.mul (.mul (.const (-1 / 1)) (.var 13)) (.var 19))) (.mul (.mul (.const (-1 / 1)) (.var 10)) (.var 16))) := rfl
  have h := centered_quadratic_lower (232537 / 1600000)

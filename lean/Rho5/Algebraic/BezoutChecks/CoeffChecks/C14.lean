/-
D07 — Bézout coefficient identity #14.
...
This is the coefficient of `z^14` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^14` in `A * P + B * P'`. -/
theorem bezoutCoeff14 (g : R) :
    ba4 g * pc10 g + ba5 g * pc9 g + ba6 g * pc8 g + ba7 g * pc7 g + ba8 g * pc6 g + bb5 g * (10 * pc10 g) + bb6 g * (9 * pc9 g) + bb7 g * (8 * pc8 g) + bb8 g * (7 * pc7 g) + bb9 g * (6 * pc6 g) = 0 := by

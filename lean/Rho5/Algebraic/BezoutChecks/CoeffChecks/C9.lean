/-
D07 — Bézout coefficient identity #9.
...
This is the coefficient of `z^9` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^9` in `A * P + B * P'`. -/
theorem bezoutCoeff9 (g : R) :
    ba0 g * pc9 g + ba1 g * pc8 g + ba2 g * pc7 g + ba3 g * pc6 g + ba4 g * pc5 g + ba5 g * pc4 g + ba6 g * pc3 g + ba7 g * pc2 g + ba8 g * pc1 g + bb0 g * (10 * pc10 g) + bb1 g * (9 * pc9 g) + bb2 g * (8 * pc8 g) + bb3 g * (7 * pc7 g) + bb4 g * (6 * pc6 g) + bb5 g * (5 * pc5 g) + bb6 g * (4 * pc4 g) + bb7 g * (3 * pc3 g) + bb8 g * (2 * pc2 g) + bb9 g * (1 * pc1 g) = 0 := by

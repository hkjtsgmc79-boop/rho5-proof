/-
D07 — Bézout coefficient identity #0.
...
This is the coefficient of `z^0` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^0` in `A * P + B * P'`. -/
theorem bezoutCoeff0 (g : R) :
    ba0 g * pc0 g + bb0 g * (1 * pc1 g) = bezoutRHS g := by

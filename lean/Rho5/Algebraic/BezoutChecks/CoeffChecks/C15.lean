/-
D07 — Bézout coefficient identity #15.
...
This is the coefficient of `z^15` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^15` in `A * P + B * P'`. -/
theorem bezoutCoeff15 (g : R) :
    ba5 g * pc10 g + ba6 g * pc9 g + ba7 g * pc8 g + ba8 g * pc7 g + bb6 g * (10 * pc10 g) + bb7 g * (9 * pc9 g) + bb8 g * (8 * pc8 g) + bb9 g * (7 * pc7 g) = 0 := by

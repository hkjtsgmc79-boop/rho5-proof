/-
D07 — Bézout coefficient identity #10.
...
This is the coefficient of `z^10` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^10` in `A * P + B * P'`. -/
theorem bezoutCoeff10 (g : R) :
    ba0 g * pc10 g + ba1 g * pc9 g + ba2 g * pc8 g + ba3 g * pc7 g + ba4 g * pc6 g + ba5 g * pc5 g + ba6 g * pc4 g + ba7 g * pc3 g + ba8 g * pc2 g + bb1 g * (10 * pc10 g) + bb2 g * (9 * pc9 g) + bb3 g * (8 * pc8 g) + bb4 g * (7 * pc7 g) + bb5 g * (6 * pc6 g) + bb6 g * (5 * pc5 g) + bb7 g * (4 * pc4 g) + bb8 g * (3 * pc3 g) + bb9 g * (2 * pc2 g) = 0 := by

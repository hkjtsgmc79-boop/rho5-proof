/-
D07 — Bézout coefficient identity #4.
...
This is the coefficient of `z^4` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^4` in `A * P + B * P'`. -/
theorem bezoutCoeff4 (g : R) :
    ba0 g * pc4 g + ba1 g * pc3 g + ba2 g * pc2 g + ba3 g * pc1 g + ba4 g * pc0 g + bb0 g * (5 * pc5 g) + bb1 g * (4 * pc4 g) + bb2 g * (3 * pc3 g) + bb3 g * (2 * pc2 g) + bb4 g * (1 * pc1 g) = 0 := by

...
def main():
    ...
    result={'status':'R52_CERTIFICATES_GRAFTED_FULL_ORIGINAL_ROOT_REPLAY_REQUIRED','parent_tree_sha256':sha(a.tree),'tree_sha256':sha(target),

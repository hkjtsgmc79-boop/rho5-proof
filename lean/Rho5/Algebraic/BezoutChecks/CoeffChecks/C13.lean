/-
D07 — Bézout coefficient identity #13.
...
This is the coefficient of `z^13` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^13` in `A * P + B * P'`. -/
theorem bezoutCoeff13 (g : R) :
    ba3 g * pc10 g + ba4 g * pc9 g + ba5 g * pc8 g + ba6 g * pc7 g + ba7 g * pc6 g + ba8 g * pc5 g + bb4 g * (10 * pc10 g) + bb5 g * (9 * pc9 g) + bb6 g * (8 * pc8 g) + bb7 g * (7 * pc7 g) + bb8 g * (6 * pc6 g) + bb9 g * (5 * pc5 g) = 0 := by

...
#include <sstream>
#include <climits>
std::array<long long,4>packet_counts{};long long rank_leaves=0;bool allow_open=false;long long opens=0;long long nodes=0,leaves=0,splits=0,total_support=0;int maxdepth=0,maxsupport=0;
...
int main(int argc,char**argv){try{
 ...
 std::cout<<"{\"status\":\""<<(opens?"R45_PARTIAL_EXACT_CHECKPOINT":"R45_FROZEN_MODEL_EXACT_TREE_PASS")<<"\",\"nodes\":"<<nodes<<",\"splits\":"<<splits<<",\"leaves\":"<<leaves<<",\"packet_interval_leaves\":"<<rank_leaves<<",\"determinant_interval_leaves\":"<<(packet_counts[0]+packet_counts[1]+packet_counts[2])<<",\"direct_packet_interval_leaves\":"<<packet_counts[3]<<",\"open\":"<<opens<<",\"max_depth\":"<<maxdepth<<",\"max_support\":"<<maxsupport<<",\"total_support\":"<<total_support<<",\"seconds\":"<<seconds<<"}"<<std::endl;

...
SOURCE_NAMES=('mc_exact_kernel.hpp','weighted_height.hpp','rankone_oracle.hpp','factor_graph.hpp','factor_oracle.hpp','mc_verify.cpp')
def verify_task(path,tree=None,allow_open=False):
 ...
 with tempfile.TemporaryDirectory(prefix='rho5_v35_verify_') as tmp:
 ...
 ans['scope']={k:data[k]for k in ('K','J','type','branch','target','actual_r_relation','proof_goal','alpha_ports_certificate_sha256','alpha_definition_sha256')}
 ans['unreceived_high_trees_replayed_here']=False
 return ans

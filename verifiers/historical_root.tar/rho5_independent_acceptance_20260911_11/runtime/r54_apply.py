...
def main():
    ...
    data['r54_binding']=binding();target=a.out/'B17_ROOT.json';target.write_text(json.dumps(data,sort_keys=True,separators=(',',':'))+'\n')
    result={'status':'R54_CERTIFICATES_GRAFTED_FULL_ORIGINAL_ROOT_REPLAY_REQUIRED','parent_tree_sha256':sha(a.tree),'tree_sha256':sha(target),

/-
D07 — Bézout coefficient identity #1.
...
This is the coefficient of `z^1` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^1` in `A * P + B * P'`. -/
theorem bezoutCoeff1 (g : R) :
    ba0 g * pc1 g + ba1 g * pc0 g + bb0 g * (2 * pc2 g) + bb1 g * (1 * pc1 g) = 0 := by

/-
D07 — Bézout coefficient identity #2.
...
This is the coefficient of `z^2` in `A * P + B * P'`, a scalar identity in an
...
/-- Coefficient of `z^2` in `A * P + B * P'`. -/
theorem bezoutCoeff2 (g : R) :
    ba0 g * pc2 g + ba1 g * pc1 g + ba2 g * pc0 g + bb0 g * (3 * pc3 g) + bb1 g * (2 * pc2 g) + bb2 g * (1 * pc1 g) = 0 := by
